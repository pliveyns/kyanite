...
> **Note**
> Everywhere in this repository, make sure to replace `pliveyns/kyanite` with the details of your own repository. Unless you used one of the automatic repository setup tools in which case the previous repo identifier should already be your repo's details.
...
```
sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/pliveyns/kyanite:20230403
```
